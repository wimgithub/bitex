...
public class Coin {
    ...
    @Column(columnDefinition = "decimal(18,2) default 0.00 comment '新加坡币汇率'")
    ...
    @Enumerated(EnumType.ORDINAL)
    @Column(columnDefinition = "int default 0 comment '是否为erc20token'")
    private BooleanEnum isErcToken = BooleanEnum.IS_FALSE;
