...
public class AdminOrderController extends BaseController {
    ...
    private void madeData(List<OtcOrderVO> list){
        for(OtcOrderVO vo:list){
            vo.setStatusCN(vo.getStatus().getCnName());
            vo.setAdvertiseTypeCN(vo.getAdvertiseType().getCnName());
        }
    }
}
